      ...
      <el-table :data="contentList" border>
        ...
        <el-table-column label="操作" fixed="right" >
          <template slot-scope="scope">
            ...
            <el-button @click="handleDelete(scope.row)" type="danger" v-permission="{permission: '删除内容', type: 'disabled'}">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    async getContentList() {
      let res = await ContentModel.getContentList();
